...
def emit_sample_run(path: str | Path, runtime_id: str, app_id: str) -> None:
    emit_event(
        ...
        agent_id="runtime",
        agent_name="Runtime Controller",
        agent_type="ORCHESTRATOR",
        event_type="RUNTIME_STARTED",
        status="RUNNING",
        lifecycle_phase="BEFORE_STARTING",
        phase="STARTUP",
    )
    time.sleep(0.05)
    emit_event(
        ...
        status="RUNNING",
        lifecycle_phase="DURING_RUNTIME",
        phase="PLANNING",
    )
    time.sleep(0.05)
    emit_event(
    ...
    emit_event(
        ...
        status="COMPLETED",
        lifecycle_phase="BEFORE_COMPLETION",
        phase="DECISION",
    ...
    emit_event(
        ...
        status="COMPLETED",
        lifecycle_phase="AFTER_COMPLETION",
        phase="COMPLETE",
        recommendation="APPROVE",
        risk_level="LOW",
        trust_score=91,
